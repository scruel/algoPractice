...
public class LeiDice {
        ...
        public static int turn[] = {0, 4, 5, 6, 1, 2, 3};
        // 冲突记录: Conflict[i][j]=0代表点数为i的面与点数为j的面存在冲突
        public static long conflict[][] = new long[7][7];

        // 获得一个单位矩阵
        public static long[][] getIdentity(long[][] a) {
        ...
        // 常数快速幂
        public static long exp_mod(long a, long n) {
                long t;
                if (n == 0)
                        return 1 % MOD;
                if (n == 1)
